...
We are trying to adapt and improve the user interface at this relatively early stage of development to minimize future changes, which would affect a larger number of users and a larger amount of user's code.
...
Most relevant changes to the interface are the following:
 ...
 - The PyHEADTAIL interface is moved from xtrack to xpart
