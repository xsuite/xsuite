...
os.system(
    'git clone --single-branch --branch feature/remove_python_particle https://github.com/xsuite/xobjects')
os.system(
    'git clone --single-branch --branch feature/remove_python_particle https://github.com/xsuite/xfields')
os.system(
    'git clone --single-branch --branch feature/remove_python_particle https://github.com/xsuite/xtrack')
os.system(
    'git clone --single-branch --branch feature/remove_python_particle https://github.com/xsuite/xpart')
