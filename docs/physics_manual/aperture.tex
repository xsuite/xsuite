...
\begin{itemize}
    ...
    \item \lstinline{tol_co} ($r_\mathrm{co}$) -- closed orbit offset allowance (in metres),
    \item \lstinline{tol_disp} ($f_D$) -- dispersion tolerance scaling factor (unitless),
    \item \lstinline{tol_disp_ref_dx} ($D'_\mathrm{ref}$) -- reference dispersion-derivative scale (in metres),
    \item \lstinline{tol_disp_ref_beta} ($\beta_{D,\mathrm{ref}}$) -- reference beta for dispersion scaling (in metres),
    \item \lstinline{tol_energy} ($f_E$) -- energy error tolerance scaling factor,
    \item \lstinline{tol_beta_beating} ($f_\beta$) -- unitless beta beating tolerance scaling factor.
...
\[
\sigma_x = \sqrt{\frac{\varepsilon_{x,\mathrm{n}}}{\gamma}\beta_x} \cdot f_\beta,
\qquad
\sigma_y = \sqrt{\frac{\varepsilon_{y,\mathrm{n}}}{\gamma}\beta_y} \cdot f_\beta.
\]
...
\begin{itemize}
    ...
    \[
		\Delta x_{D,\beta} := f_\beta \cdot f_D \cdot D'_\mathrm{ref} \cdot \sqrt{\frac{\beta_x}{\beta_{D,\mathrm{ref}}}} \cdot \delta_\mathrm{rms},
		\qquad
		\Delta y_{D,\beta} := f_\beta \cdot f_D \cdot D'_\mathrm{ref} \cdot \sqrt{\frac{\beta_y}{\beta_{D,\mathrm{ref}}}} \cdot \delta_\mathrm{rms},
	\]
...
\]
Wy can transform a plane, which is represented as a (Cartesian) normal $(v_X, v_Y, v_Z)$ attached to a (curvilinear) point $(x, y, s)$, like so:
\[
