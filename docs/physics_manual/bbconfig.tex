...
\begin{figure}[t]
\centering
\includegraphics[width=.8\textwidth, trim=0cm 1cm 0cm 1cm, clip]{xang_xplane.png}
...
\begin{figure}[p]
\centering
\includegraphics[width=.87\textwidth, trim=0cm 0cm 0cm 0cm, clip]{b1ip1.png}
...
\includegraphics[width=.87\textwidth, trim=0cm 0cm 0cm 0cm, clip]{b4ip1.png}
...
\begin{figure}[p]
\centering
\includegraphics[width=.87\textwidth, trim=0cm 0cm 0cm 0cm, clip]{b1ip5.png}
...
\includegraphics[width=.87\textwidth, trim=0cm 0cm 0cm 0cm, clip]{b4ip5.png}
