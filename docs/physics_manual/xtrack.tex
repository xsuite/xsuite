...
\section{Linearized synchrotron motion}

Definition of momentum compation factor:
\begin{equation}
\alpha_c = 
\frac{\Delta C/C}{\Delta P/P_0}
\end{equation}

Slip factor:
\begin{equation}
\eta = -\frac{\Delta f/f_0}{\Delta P/P_0} = \alpha_c - \frac{1}{\gamma_0^2}
...
= -\eta \frac{\beta_0 c}{f_0}\frac{\Delta P}{P_0}
= -\eta C \frac{\Delta P}{P_0}
\end{align}
...
\end{align}
Assuming $\phi_{RF}$ and for small sign argument:
\begin{align}
\Delta E
& = -2 \pi q h_{RF} V_{RF} \frac{\zeta}{C} 
  = -2 \pi q f_{RF} V_{RF} \frac{\zeta}{\beta_0 c}
\end{align}
