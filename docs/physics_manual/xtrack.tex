...
\begin{align}
\Delta p_\zeta \approx \frac{q V_{RF}}{\beta_0^2E_0}\sin\left(-2 \pi f_{RF} \frac{\zeta_0}{\beta_0 c} + \phi_{RF}\right) -\frac{2\pi q V_{RF}}{\beta_0^3 E_0 c}(\zeta-\zeta_0)\cos\left(-2\pi f_{RF} \frac{\zeta_0}{\beta_0 c} + \phi_{RF}\right)
\end{align}
...
obtaining:
\begin{align}
\Delta p_\zeta \approx \frac{q V_{RF}}{\beta_0^2E_0}\sin{\phi_s} -\frac{2\pi q V_{RF}}{\beta_0^3 E_0 c}\hat{\zeta}\cos{\phi_s}
\end{align}

We also fro the energy variable we subtract the fixed point:
\begin{align}
\Delta \hat{p}_\zeta = \Delta {p}_\zeta - \Delta {p}_{\zeta 0}
\end{align}

obtaining:
\begin{align}
\Delta \hat{p}_\zeta \approx -\frac{2\pi q V_{RF}}{\beta_0^3 E_0 c}\cos{\phi_s}\hat{\zeta}
\end{align}
...
%\begin{align}
%\Delta p_\zeta = \frac{\Delta E}{\beta_0^2E_0} 
%= \frac{q V_{RF}}{\beta_0^2E_0}
%\sin\left(-2 \pi f_{RF} \frac{\zeta}{\beta_0 c}\right) \cos\phi_{RF}
%+ \cos\left(2 \pi f_{RF} \frac{\zeta}{\beta_0 c}\right) \sin\phi_{RF}
%\end{align}

%Assuming $\phi_{RF}$ and for small sin argument:
%\begin{align}
%\Delta p_\zeta = \frac{\Delta E}{\beta_0^2E_0} 
%= -\frac{q V_{RF}}{\beta_0^2E_0}\sin\left(-2 \pi f_{RF} \frac{\zeta}{\beta_0 c} \right)
%\end{align}

%Synchrotron tune:
%\begin{equation}
%Q_s = \sqrt{\frac{q_0 V_{RF} \eta h_{RF}}{2 \pi E_0 \beta_0^2}}
%\end{equation}
