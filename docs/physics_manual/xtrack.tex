...
Emitted power:
\begin{equation}
P_{\mathrm{s}}=\frac{2 r_0 c m_0 c^2 \gamma^4}{3 \rho^2}=\frac{2 r_0 c^3 e^2 \gamma^2 B^2}{3 m_0 c^2}=\frac{2 r_0 c^3 e^2 E_{\mathrm{e}}^2 B^2}{3\left(m_0 c^2\right)^3}
\end{equation}

Classical particle radius:

\begin{equation}
r_0=e^2 /\left(4 \pi \epsilon_0 m_0 c^2\right)
\end{equation}

Curvature, rigidity, field:
\begin{equation}
\frac{1}{\rho}=\frac{e B}{p}=\frac{e B}{m_0 c \gamma}
\end{equation}

Critical frequency:
\begin{equation}
\omega_{\mathrm{c}}=\frac{3 c \gamma^3}{2 \rho}
=\frac{3 e\gamma^2 B }{2 m_0}
\end{equation}

Critical energy:
\begin{equation}
E_{\gamma \mathrm{c}}=\hbar \omega_{\mathrm{c}}
=\frac{3 e\hbar\gamma^2 B }{2 m_0}
\end{equation}
...
\begin{align}
\Delta \varepsilon_x = <\Delta J_x> = 
\frac{1}{2}\left(\mathcal{K}_x + \mathcal{K}_{p_x}\right)<\Delta \delta^2>
\end{align}
...
\frac{1}{2T_0c}\int_0^C\left(\mathcal{K}_x + \mathcal{K}_{p_x}\right)<\dot{N} \Delta \delta^2> \,ds
...
\begin{align}
\varepsilon_x= 
\frac{1}{4\alpha_xc}\int_0^C\left(\mathcal{K}_x + \mathcal{K}_{p_x}\right)<\dot{N} \Delta \delta^2> \,ds
\label{eq:equilemi1}
\end{align}

For synchrotron radiation there is a closed for for the photon distribution moment\,\cite{chao_eq_emit}:
\begin{align}
<\dot{N} \Delta \delta^2> = 
\frac{1}{2\pi\varepsilon_0}
\frac{55\sqrt{3}}{48}
\frac{q_0^2q_e^2 \hbar c}{\left(m_0 c^2\right)^2}
\frac{\gamma_0^3}{\lvert\rho \rvert^3} \gamma^2
\end{align}

Replacing in Eq.\,\ref{eq:equilemi1} we obtain:

\begin{align}
\varepsilon_x= 
\frac{1}{4\pi\varepsilon_0}
\frac{55\sqrt{3}}{96}
\frac{q_0^2q_e^2 \hbar }{\left(m_0 c^2\right)^2}
\frac{\gamma_0^3}{\alpha_x}
\int_0^C\left(\mathcal{K}_x + \mathcal{K}_{p_x}\right) 
\frac{1}{\lvert\rho \rvert^3} \gamma^2 \,ds
\label{eq:equilemi2}
\end{align}
