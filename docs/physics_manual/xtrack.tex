...
A similar type of calculation can be done for the other planes, and for higher order types of dispersion such as $D_{px}^{p_\zeta}$.
...
A similar type of calculation can be done for the other planes, and for higher order types of crab dispersion such as $D_{px}^{\zeta}$.
