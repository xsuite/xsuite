...
\begin{align}
A_x &= \sqrt{\hat{x}^2 + \hat{p}^2_x} = \sqrt{2J_x},\\
...
\begin{equation}
\frac{1}{A_x} \frac{dA_x}{dn} = - \alpha_x
\end{equation}
from which:
\begin{equation}
\frac{dJ_x}{dn} = - 2 \alpha_x J_x
\end{equation}
By averaging over the beam distribution we obtain:
\begin{equation}
\frac{d\varepsilon_x}{dn} = - 2 \alpha_x \varepsilon_x
\end{equation}
...
\begin{align}
\Delta \tilde{x} &= \mathcal{K}_x \Delta \delta \\
\Delta \tilde{p}_x &= \mathcal{K}_{p_x} \Delta \delta \\
\Delta \tilde{y} &= \mathcal{K}_{y} \Delta \delta \\
\Delta \tilde{p}_y &= \mathcal{K}_{p_y} \Delta \delta\\
\Delta \tilde{\zeta} &= \mathcal{K}_{\zeta} \Delta \delta \\
\Delta \tilde{p}_\zeta &= \mathcal{K}_{p_{\zeta}}\Delta \delta
\end{align}
