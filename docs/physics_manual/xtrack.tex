...
\begin{align}
    \dee \epsilon_u = - 2 \frac{P_s}{cE_0} &\left[ 1 + \left( h_{0u} + 2 \frac{h_u}{h^2} k_1 \right) u_\beta \right] \times \dots \\
...
We define the fifth radiation integral, $I_{5u}$, as followes:
\begin{equation}
