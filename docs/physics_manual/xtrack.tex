...
We define for each particle:
\begin{equation}
\hat{\beta}(s) = \frac{ds}{dt}
\end{equation}
...
\begin{equation}
\hat{\beta}(s) < \beta_\text{sim} \quad \text{far all particles at all times}
\label{eq:betasim1}
\end{equation}
\begin{equation}
\hat{\beta}(s) > \frac{\beta_\text{sim}}{2} \quad \text{far all particles at all times}
\label{eq:betasim2}
\end{equation}
...
\end{equation}
\begin{equation}
\hat{\beta}(s) > \frac{\beta_\text{sim}}{2} 
\quad \Rightarrow \quad
\frac{1}{\hat{\beta}(s)} > \frac{2}{\beta_\text{sim}}
\quad \Rightarrow \quad
\left(
\frac{1}{\hat{\beta}(s)} - \frac{1}{\beta_\text{sim}}
