...
A Gaussian distribution is defined such that the distribution with respect to the each action can be written as:
\begin{equation}
...
\section{Equilibrium emittance from synchrotron radiation}
