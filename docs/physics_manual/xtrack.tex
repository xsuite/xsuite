...
\phi_y(p_x, p_y, p_z) &= \frac{(1+\delta)^2-p_y^2}{p_z^3}\\
\phi_x(p_x, p_y, p_z) &= \frac{(1+\delta)^2-p_x^2}{p_z^3}\\
\end{align}
...
\phi_y(p_y, p_z, \delta) +x^{\prime 2} \phi_x(p_x, p_z, \delta)
\right)
\end{equation}
...
-g k_0^2 f_\text{int} \left(
\frac{\partial \phi_y}{\partial p_z}\frac{\partial p_z}{\partial p_x}
+ 2x'\frac{\partial x'}{\partial p_x}\phi_x
+x'^2 
\left(
\frac{\partial \phi_x}{\partial p_x} +
\frac{\partial \phi_x}{\partial p_z}
\frac{\partial p_z}{\partial p_x}
\right)
\right)\\
%
...
\frac{\partial \phi_y}{\partial p_z}
\frac{\partial p_z}{\partial p_y}
\right)
+ 2x'\frac{\partial x'}{\partial p_y}\phi_x
+x'^2 
\frac{\partial \phi_x}{\partial p_z}\frac{\partial p_z}{\partial p_y}
\right)\\
%
...
\frac{\partial \phi_y}{\partial p_z}
\frac{\partial p_z}{\partial \delta}
\right)
...
\begin{align}
x' &= \frac{p_x}{p_z}\\
\frac{\partial x'}{\partial p_x} &= \frac{1}{p_z} - \frac{p_x}{p_z^2}\frac{\partial p_z}{\partial p_x}
\end{align}
