...
A_x &= \cos\theta \cdot A_{x'} - \sin\theta \cdot A_{z'} 
    %= \cos\theta \left(-\frac{B_A(z')}{2} y \right) - \sin\theta \cdot 0 
    = -\frac{B_A(z')}{2} \, y \cos\theta \\
A_y &= A_{y'}
    %= \frac{B_A(z')}{2} x' 
    = \frac{B_A(z')}{2} (x \cos\theta + z \sin\theta) \\
A_z &= \sin\theta \cdot A_{x'} + \cos\theta \cdot A_{z'} 
    %= \sin\theta \left(-\frac{B_A(z')}{2} y \right) + \cos\theta \cdot 0 
    = -\frac{B_A(z')}{2} \, y \sin\theta
\end{align}
