...
The first term can be identified as $I_2$, such that:
\begin{align}
...
As stated above on the closed orbit we assume $E/E_0 \approx 1$. Furthermore, the $h_xh_{0x}x \ll h_x$, so the above may be written as
\begin{align}
    \totder{U_s}{E} = &\frac{2}{3} r_0 \gamma^3 \bigg\{ 2I_2 + \dots\\
