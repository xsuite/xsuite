...
\usepackage[margin=2.6cm, bottom=3.cm, top=3.cm, portrait]{geometry}
\usepackage{caption}
...
\newcommand{\dee}[0]{\text{d}}
\newcommand{\totder}[2]{\frac{\dee  {#1}}{\dee  {#2}}}
\newcommand{\partder}[2]{\frac{\partial {#1}}{\partial {#2}}}
\newcommand{\mean}[1]{\left\langle {#1} \right\rangle}
\newcommand{\curlyH}[0]{\mathcal{H}}
...
\input{xtrack.tex}
\input{splineboris_field_expansion.tex}
\input{spatial_boris.tex}
\input{xfields.tex}
