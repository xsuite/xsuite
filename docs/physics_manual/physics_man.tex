...
\\
\Delta s &= s \frac{\beta}{\beta_0} - \beta c t &
\tau &= \frac{s}{\beta_0} - ct &
\sigma &= s - \beta_0 ct &
\end{align}

The pairs $(\Delta s, \delta)$, $(\tau, p_\tau)$, $(\sigma, p_\sigma)$ are canonical conjugate and can be generated by the following generating functions \footnote{
%$F_2(q, P, t)$,
