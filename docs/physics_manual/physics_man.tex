...
For the longitudinal coordinates, there are three conventions, all with time-like position
coordinates:
\begin{align}
...
The different variants can be easily related to each other:
\begin{align}
  \xi    &=
      \beta\tau =
...
Hamiltonian contains terms with $\beta$, which is not independent as $\beta$ depends
on the energy as well! In particular:
\begin{equation}
