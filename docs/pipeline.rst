...
It is important that the Particles instances as well as the :class:`xtrack.Element` instances in the line that require communication through the pipeline are attributed a uniquely defined name. 
